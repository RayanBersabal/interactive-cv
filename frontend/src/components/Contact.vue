...
rounded-lg hover:bg-blue-700 transition-colors duration-300 inline-block mb-12">
 ...
 <a href="#" target="_blank" class="text-gray-400 hover:text-white transition-colors duration300">GitHub</a>
 <a href="#" target="_blank" class="text-gray-400 hover:text-white transition-colors duration300">LinkedIn</a>
 </div>
